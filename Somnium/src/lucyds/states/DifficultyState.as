package lucyds.states {
	...
	public class DifficultyState extends FlxState
	{
		...
		{
			var resetTxt : FlxText= new FlxText(0, FlxG.height / 2 - 192, FlxG.width, "Remettre la difficulté à zéro ?");
			resetTxt.setFormat (null, 32, 0xFFFFFFFF, "center");
			add(resetTxt);
			
			no = new FlxText(0, FlxG.height / 2 - 128, FlxG.width, "Non");
			no.setFormat (null, 32, 0xFFFFFFFF, "center");
			add(no);			
			
			yes = new FlxText(0, FlxG.height / 2 - 64, FlxG.width, "Oui");
